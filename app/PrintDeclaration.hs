...
instance Print TopDef where
  prt i e = case e of
    ...
    StructDef id structdecls -> prPrec i 0 (concatD [doc (showString "struct"), prt 0 id, doc (showString "{"), prt 0 structdecls, doc (showString "}")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print StructDecl where
  prt i e = case e of
    Field type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ";")])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print StructField where
  prt i e = case e of
    StructField id -> prPrec i 0 (concatD [prt 0 id])
  prtList _ [x] = (concatD [prt 0 x])
...
instance Print Stmt where
  prt i e = case e of
    ...
    ArrAss id n expr -> prPrec i 0 (concatD [prt 0 id, doc (showString "["), prt 0 n, doc (showString "]"), doc (showString "="), prt 0 expr, doc (showString ";")])
    StructAss structfields expr -> prPrec i 0 (concatD [prt 0 structfields, doc (showString "="), prt 0 expr, doc (showString ";")])
    ...
    FnInDef type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    ...
    Try block catchs -> prPrec i 0 (concatD [doc (showString "try"), prt 0 block, prt 0 catchs])
    Throw expr -> prPrec i 0 (concatD [doc (showString "throw"), prt 0 expr, doc (showString ";")])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
...
instance Print Catch where
  prt i e = case e of
    Catch arg block -> prPrec i 0 (concatD [doc (showString "catch"), doc (showString "("), prt 0 arg, doc (showString ")"), prt 0 block])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print Type where
  prt i e = case e of
    ...
    StructType id -> prPrec i 0 (concatD [prt 0 id])
    ...
    ArrayType type_ -> prPrec i 0 (concatD [doc (showString "array"), doc (showString "<"), prt 0 type_, doc (showString ">")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print Expr where
  prt i e = case e of
    ...
    SLitString str -> prPrec i 6 (concatD [prt 0 str])
    ...
    EArray exprs -> prPrec i 6 (concatD [doc (showString "["), prt 0 exprs, doc (showString "]")])
    EArrayIdx id n -> prPrec i 6 (concatD [prt 0 id, doc (showString "["), prt 0 n, doc (showString "]")])
    EField structfields -> prPrec i 6 (concatD [prt 0 structfields])
